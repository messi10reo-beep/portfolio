...
window.NAGI_FAQ = [
  ...
  { id: "access", category: "アクセス・場所",
    question: "場所はどこですか？／最寄り駅から何分ですか？",
    answer: "東京・中目黒駅から徒歩5分です。住所は目黒区（詳細はご予約確定時にご案内）。1階に看板を出しています。電車でのご来店が便利で、近隣にコインパーキングもございます。",
    keywords: ["場所", "どこ", "アクセス", "駅", "中目黒", "行き方", "住所", "地図", "最寄り", "立地", "近く"] },
  { id: "male", category: "男性の利用",
    question: "男性でも利用できますか？",
    answer: "はい、男性のお客様も多くご利用いただいています。デスクワークによる肩こり・腰痛のケアや、姿勢改善のご相談も歓迎です。完全予約・個室のため、まわりを気にせずお過ごしいただけます。",
    keywords: ["男性", "男", "メンズ", "旦那", "彼氏", "男でも", "性別"] },
  { id: "sameday", category: "当日予約",
    question: "当日でも予約できますか？／飛び込みは可能ですか？",
    answer: "空きがあれば当日のご予約も承ります。完全予約制のため飛び込みでのご案内は難しいことが多いですが、当日でもまずはお電話かWeb予約でお問い合わせください。直前の空き状況をお調べします。",
    keywords: ["当日", "直前", "飛び込み", "これから", "本日", "今日いけ", "今日行け"] },
  { id: "frequency", category: "通う頻度",
    question: "どれくらいのペースで通えばいいですか？",
    answer: "お悩みの状態によりますが、はじめは2〜3週間に1回のペースで通っていただくと変化を感じやすいです。良い状態が保てるようになったら、月1回のメンテナンスへ移行する方が多いです。カウンセリングで一人ひとりに合うペースをご提案します。",
    keywords: ["頻度", "ペース", "何回", "週に", "どのくらい通", "どれくらい通", "通えば", "継続", "通い", "間隔", "メンテナンス"] },
  { id: "gift", category: "ギフト・回数券",
    question: "ギフト券や回数券はありますか？／有効期限は？",
    answer: "ギフト券（施術プレゼント）と回数券（5回 33,000円）をご用意しています。回数券の有効期限は購入日から6か月です。ギフト券はご家族・ご友人へのプレゼントにご利用いただけます。詳しくはご来店時にご案内します。",
    keywords: ["ギフト", "プレゼント", "贈り物", "ギフト券", "チケット", "回数券", "有効期限", "期限", "家族"] },
  { id: "room", category: "個室・設備",
    question: "個室ですか？／プライバシーは大丈夫ですか？",
    answer: "施術はすべて個室で行います。他のお客様と顔を合わせにくい動線になっており、着替えスペース・お手洗いも完備しています。落ち着いた空間でゆっくりお過ごしください。",
    keywords: ["個室", "プライバシー", "他の人", "周り", "まわり", "設備", "更衣", "ロッカー", "空間"] },
  { id: "strength", category: "施術の強さ",
    question: "強さは調整できますか？／痛いのが苦手です。",
    answer: "もちろん調整できます。施術中も「もう少し弱く／強く」とお気軽にお申し付けください。痛みが苦手な方にはソフトな圧から始め、ご様子をうかがいながら進めます。強ければ良いというものではなく、無理のない範囲でほぐします。",
    keywords: ["強さ", "痛い", "強め", "弱め", "ソフト", "加減", "痛く", "調整", "苦手", "圧"] },
  { id: "condition", category: "通院中・持病",
    question: "通院中・持病があっても受けられますか？",
    answer: "お薬を服用中・通院中の方は、ご予約時にお知らせください。内容によっては主治医にご確認のうえでのご案内となります。発熱時や強い炎症がある場合など、施術をお控えいただくケースもあります。安全を最優先にご案内します。",
    keywords: ["通院", "持病", "病気", "薬", "服用", "主治医", "病院", "怪我", "けが", "炎症", "受けられ"] },
  { id: "late", category: "遅刻・遅れ",
    question: "遅刻しそうなときはどうすればいいですか？",
    answer: "わかった時点でお電話でご連絡ください。次のご予約の状況により、施術時間を短縮してのご案内となる場合があります（料金は変わりません）。15分以上の無連絡の遅刻は、キャンセル扱いとさせていただくことがあります。",
    keywords: ["遅刻", "遅れ", "間に合わ", "遅延", "遅く", "連絡"] },
  { id: "receipt", category: "領収書",
    question: "領収書（インボイス）は発行できますか？",
    answer: "はい、領収書を発行できます。ご希望の宛名でお出ししますので、会計時にお申し付けください。適格請求書（インボイス）の様式が必要な場合も、事前にお知らせいただければ対応いたします。",
    keywords: ["領収書", "領収証", "インボイス", "適格請求書", "宛名", "経費", "明細"] }
];
